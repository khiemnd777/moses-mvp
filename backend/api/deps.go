...
type handlerStore interface {
	...
	CreateDocumentUpload(ctx context.Context, input domain.DocumentUploadInput) (domain.DocumentUpload, error)
	CreateDocumentUploadEvent(ctx context.Context, input domain.DocumentUploadEventInput) (domain.DocumentUploadEvent, error)
	GetDocumentUpload(ctx context.Context, id string) (domain.DocumentUpload, error)
	ListDocumentUploads(ctx context.Context, limit int) ([]domain.DocumentUpload, error)
	ApproveDocumentUpload(ctx context.Context, id string, docType domain.DocType, analysisJSON []byte, actor, reason string) (domain.DocumentUploadPromotion, error)
	ReindexDocumentUpload(ctx context.Context, id, actor, reason string) (domain.IngestJob, bool, error)
	UpdateDocumentUploadReviewStatus(ctx context.Context, id, status, action, actor, reason string) (domain.DocumentUpload, error)
