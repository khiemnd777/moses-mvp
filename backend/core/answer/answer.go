...
func buildPrompt(question string, sources []Source) string {
	...
	b.WriteString("If the context is relevant but incomplete, answer the supported part and say what extra facts or sources are still needed.\n")
	b.WriteString("Only refuse when no retrieved source supports the legal question.\n")
